    ...
    <div className="pt-32 pb-24 min-h-screen bg-off-white flex items-center justify-center px-6">
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl w-full items-center">
            <div>
                ...
                <div className="text-2xl font-serif text-navy">33 3336 3636</div>
                <div className="text-gray-400 mt-2">ventas@altacalifornia.com</div>
            </div>
            <FormContainer 
...
export const ReferralPage: React.FC = () => (
    <div className="pt-32 pb-24 min-h-screen bg-off-white flex flex-col items-center justify-center px-6">
        <div className="text-center mb-12 max-w-2xl">
            ...
            <p className="text-gray-500">Invita a tus amigos y familiares a vivir en Alta California y recibe una bonificación exclusiva al escriturar.</p>
        </div>
