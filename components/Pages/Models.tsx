          ...
          {HOUSE_MODELS.map((model, index) => (
              ...
              >
                  <motion.div 
                    ...
                    className="w-full md:w-1/2 overflow-hidden rounded-xl shadow-2xl aspect-[4/3]"
                  >
                      <img src={model.image} alt={model.name} className="w-full h-full object-cover hover:scale-105 transition-transform duration-1000" />
                  </motion.div>
                  ...
                  >
                      ...
                      <button className="bg-navy text-white px-8 py-3 rounded-full text-xs uppercase tracking-widest hover:bg-gold transition-colors duration-300">
                          Descargar Ficha
                      </button>
                  </motion.div>
              </div>
