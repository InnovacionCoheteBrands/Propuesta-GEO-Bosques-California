        ...
        <div ref={horizontalRef} className="bg-off-white overflow-hidden relative">
            ...
            >
                ...
                {HOUSE_MODELS.map((model, index) => (
                    ...
                    >
                        <span className="absolute inset-0 flex items-center justify-center text-[15vw] md:text-[20vw] font-serif text-forest font-bold pointer-events-none z-0 select-none" style={{ opacity: 0.15 }}>
                            {model.bgText}
                        </span>
                        <div className="model-card relative z-10 grid md:grid-cols-2 gap-8 md:gap-16 items-center max-w-6xl w-full">
                            ...
                            <div className="text-center md:text-left">
                                ...
                                <button onClick={() => handleNavigate('modelos')} className="bg-gold text-white px-8 py-3 rounded-full uppercase text-xs tracking-widest hover:bg-forest hover:-translate-y-1 shadow-md hover:shadow-lg transition-all duration-300">
                                    Ver Ficha
                                </button>
                            </div>
                        </div>
